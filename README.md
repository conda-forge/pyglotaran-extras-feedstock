...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyglotaran-extras-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15333&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyglotaran-extras-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyglotaran-extras` can be installed with:

```
conda install pyglotaran-extras
```

It is possible to list all of the versions of `pyglotaran-extras` available on your platform with:
